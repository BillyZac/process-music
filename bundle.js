...
module.exports = function (rate1, rate2) {
...
var startLoop = __webpack_require__(5);
var updateUI = __webpack_require__(0);
var getPlaybackRate = __webpack_require__(4);

module.exports = function (sourceAudioFileURI) {
  var audioContext = new AudioContext();

  fetch(sourceAudioFileURI).then(function (response) {
    return response.arrayBuffer();
  }).then(function (arrayBuffer) {
    return audioContext.decodeAudioData(arrayBuffer);
  }).then(function (audioBuffer) {
    var loop1 = startLoop(audioContext, audioBuffer, -1, 1);
    var loop2 = startLoop(audioContext, audioBuffer, 1, 1);
    document.addEventListener('mousemove', function (event) {
      var rate1 = getPlaybackRate(event.clientX);
      var rate2 = getPlaybackRate(event.clientY);
...
module.exports = function startLoop(audioContext, audioBuffer) {
...
var updateUI = __webpack_require__(0);
var processMusic = __webpack_require__(1);

var sourceAudioFileURI = './audio/bowhill-trimmed.wav';
